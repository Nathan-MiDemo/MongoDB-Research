...
class TestFiles(unittest.TestCase):
    def mime_test(self, mime_type, extension):
        ...
        self.assertIs(extension, files.mime_types[type][subtype])
    ...
    def test_mime_type_fixed_subtype(self):
        ...
        self.assertIs(type, "audio")
        self.assertIs(subtype, "mpeg")
        self.assertIs(extension, "mp3")
        self.mime_test(mime_type, extension)
    ...
    def test_full_file(self):
        ...
        self.assertIs(file_type, files.mime_types[type, subtype])